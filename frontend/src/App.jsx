      ...
      >
        <main className="flex-grow pt-20">
          <Routes>
            ...
            <Route path="/seller/handbook" element={<SellerHandbook />} />
            <Route path="/seller/stories" element={<SellerStories />} />
            ...
            <Route path="/resale/create" element={<ProtectedRoute><CreateResale /></ProtectedRoute>} />
            ...
            <Route path="/seller/wallet" element={<ProtectedRoute requiredRole="seller"><SellerWallet /></ProtectedRoute>} />
            ...
            <Route path="/admin/resale" element={<ProtectedRoute requiredRole="admin"><AdminResale /></ProtectedRoute>} />
            ...
            <Route path="/admin/upcoming-products" element={<ProtectedRoute requiredRole="admin"><AdminUpcomingProducts /></ProtectedRoute>} />
